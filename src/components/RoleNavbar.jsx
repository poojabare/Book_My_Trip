...
const RoleNavbar=({isLoggedIn})=>{
    ...
    return (
        ...
        return (
            ...
            <li className="nav-item active">
                <Link className="nav-link text-dark " to="/add-product">Add Tour Package</Link>
            </li>
            <li className="nav-item active">
                <Link className="nav-link text-dark " to="/myproducts">Tour Packages</Link>
            </li>          
    ...
    return (
        ...
        <li className="nav-item active text-dark fw-bold">
            ...
            <Link className="nav-link text-dark fw-bold" to="/guides">Tour Operator</Link>
