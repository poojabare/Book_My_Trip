                ...
                <div className="col-sm-6 mx-auto" style={{ height:"1000px" }}>
                    <h4 className="text-center p-2  " style={{ color:"black" }}>
                            ...
                            <div className="form-group form-row">
                                ...
                                <label className="col-sm-4 form-control-label font-weight-bold">Tour Name</label>
                            ...
                            <div className="form-group form-row">
                                <label className="col-sm-4 form-control-label font-weight-bold">Set Tour Date</label>
                                <div className="col-sm-8">
                            ...
                            <button className="btn btn-primary float-right">Add Tour Package</button>
                    </form>
                </div>
            </div>
        </div>
